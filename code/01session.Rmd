...
# Unser Ziel
@Phil: Überblick Workshop-Projekt-Ziel
...
Inzwischen haben wir zwar den Teil der html-Seite, die uns interessiert - aber noch nicht in einer brauchbaren Form für weitere Analysen. Daher once again: Datenbereinigung! @Phil
...
congress_elections %>%
  ...
  bind_rows(.id = "frame") %>% 
    drop_na() %>% 
    add_count(frame, name = "no_candidates") %>% View()
```
...
saveRDS(task_data1, "data/task_data1.RDS")
saveRDS(task_data2, "data/task_data2.RDS")
```
