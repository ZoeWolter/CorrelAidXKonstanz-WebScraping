...
## Scaaaale it up! We gotta cacht 'em all!
...
## Inependent Expenditures ziehen
...
```
Wir könnten uns auch anschauen welche PACs besonders gerne an Objector spenden.
...
Findet den PAC mit den höchsten Ausgaben. Einmal für Objector und einmal für non-objector.
```{r}
